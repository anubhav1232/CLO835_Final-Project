...
# Background image URL (from environment variable)
BACKGROUND_IMAGE_URL = os.environ.get('BACKGROUND_IMAGE_URL', 'https://via.placeholder.com/1920x1080.png?text=Background+Image')
